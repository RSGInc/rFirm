...
if [ "$TRAVIS_REPO_SLUG" == "RSGInc/freightsim" ] && \
        ...
        git clone --quiet --single-branch --branch=gh-pages https://${GH_TOKEN}@github.com/RSGInc/freightsim.git  gh-pages > /dev/null 2>&1
