...
USER_COST_CORES <- 8L # How many processors should be used to create inputs for PMG? (a number, followed by L to indicate integer)
...
USER_FUTRE_MAX_SIZE <- 20 # Maximum amount of RAM that can be used by a future processor. Units: Gb
...
USER_MARKETS_ALL <- FALSE # Markets to run, TRUE: ALL, FALSE: Partial
USER_COMMODITIES_RUN <- c(25) # Commodities to run if running partial market run. An array of SCTG.
